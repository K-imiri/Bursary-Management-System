...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 510, 140, 40));
    ...
    private void jButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegisterActionPerformed
        ...
        String regPassword = jTextRegPassword.getText();
        String securityQuestion = jComboBoxRegSecurityQuestion.getSelectedItem().toString();
        String regAnswer = jTextRegAnswer.getText();
        ...
        if(regName.isEmpty()|| regEmail.isEmpty()|| regPassword.isEmpty()|| securityQuestion.isEmpty() || regAnswer.isEmpty()|| regWard.isEmpty()){
            ...
            JOptionPane.showMessageDialog(null, "Please enter a valid Email Address","Invalid Email Address",JOptionPane.ERROR_MESSAGE);
        }
        else{
