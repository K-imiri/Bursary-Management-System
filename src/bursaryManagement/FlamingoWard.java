...
public class FlamingoWard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonLogOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 20, 130, 48));
        ...
        getContentPane().add(jButtonExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 20, 130, 48));
        ...
        getContentPane().add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 640, 150, 50));
        ...
        getContentPane().add(jButtonViewList, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 640, 150, 50));
        ...
        getContentPane().add(jButtonRejectList, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 640, -1, 50));
            ...
            try {
                ...
                //Confirm ID exist in IEBC Register
                    ...
                    //If ID Number Does Not Exists in the IEBC Register
                        ...
                        score +=0;
                        String query = "INSERT INTO flaDuplicateID VALUES ('"+stdName+"','"+admNumber+"','"+nationalID+"','"+gender+"','"+phoneNumber+"','"+institutionName+"','"+campus+"','"+educLevel+"','"+perfomance+"','"+yearOfStudy+"','"+disability+"','"+disabilityProof+"','"+livingWith+"','"+supportDOC+"','"+sibling+"','"+chiefRecommend+"','"+arrears+"','Flamingo','Student not a resident of constituency')";
