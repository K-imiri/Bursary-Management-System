...
public class MenengaiWard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonLogOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 20, 133, 54));
        ...
        getContentPane().add(jButtonExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 20, 133, 54));
        ...
        getContentPane().add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 620, 170, 50));
        ...
        getContentPane().add(jButtonViewList, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 620, 170, 50));
        ...
        getContentPane().add(jButtonRejectedList, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 620, 210, 50));
            ...
            try {
                ...
                //Confirm ID exist in IEBC Register
                    ...
                    //If ID Number Does Not Exists in the IEBC Register
                        ...
                        score +=0;
                        String query = "INSERT INTO menduplicateID VALUES ('"+stdName+"','"+admNumber+"','"+nationalID+"','"+gender+"','"+phoneNumber+"','"+institutionName+"','"+campus+"','"+educLevel+"','"+perfomance+"','"+yearOfStudy+"','"+disability+"','"+disabilityProof+"','"+livingWith+"','"+supportDOC+"','"+sibling+"','"+chiefRecommend+"','"+arrears+"','Menengai Ward','Student not a resident of constituency')";
