...
public class NakuruEastWard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonRejectList = new javax.swing.JButton();
        ...
        getContentPane().add(jButtonLogOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 20, -1, 50));
        ...
        getContentPane().add(jButtonExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 20, 100, 50));
        ...
        getContentPane().add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 620, 160, 50));
        ...
        getContentPane().add(jButtonViewList, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 620, 160, 50));

        jButtonRejectList.setBackground(new java.awt.Color(0, 153, 0));
        jButtonRejectList.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButtonRejectList.setForeground(new java.awt.Color(255, 255, 255));
        jButtonRejectList.setText("View Rejected List");
        jButtonRejectList.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonRejectListActionPerformed(evt);
            }
        });
        getContentPane().add(jButtonRejectList, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 620, 230, 50));
            ...
            try {
                ...
                //Confirm ID exist in IEBC Register
                    ...
                    //If ID Number Does Not Exists in the IEBC Register
                        ...
                        score +=0;
                        String query = "INSERT INTO nkrDuplicateID VALUES ('"+stdName+"','"+admNumber+"','"+nationalID+"','"+gender+"','"+phoneNumber+"','"+institutionName+"','"+campus+"','"+educLevel+"','"+perfomance+"','"+yearOfStudy+"','"+disability+"','"+disabilityProof+"','"+livingWith+"','"+supportDOC+"','"+sibling+"','"+chiefRecommend+"','"+arrears+"','Nakuru East','Student not a resident of constituency')";
    ...
    private void jButtonRejectListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRejectListActionPerformed
        setVisible(false);
        new NakEastDuplicateID().setVisible(true);
    }//GEN-LAST:event_jButtonRejectListActionPerformed
    ...
    private javax.swing.JButton jButtonRejectList;
